...
<template>
  <div
    ...
    :key="project.id"
    class="p-6 shadow-lg rounded hover:bg-gray-50 ring-indigo-800 ring-1 transition ease-in-out hover:-translate-y-1 hover:scale-103 duration-300"
  >
    ...
    <div class="mt-4 flex justify-start space-x-6 lg:space-x-8">
      <div class="flex auto">
        <Icon
          ...
          size="1.1rem"
          class="text-indigo-700 mb-1 self-center"
        />
        <span>Stars:</span>
      ...
      <div class="flex auto">
        <Icon
          ...
          size="1.1rem"
          class="text-indigo-800 mb-1 self-center"
        />
        <span> Forks:</span>
        <span class="ml-2 justify-items-center">{{
